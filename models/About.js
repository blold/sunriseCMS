...
About.add(
	'Top Section', {
		...
		aboutImg: { type: Types.File, storage: storage('img/about'), label: '关于我们-图片' },
	},
	'Vision Secion', {
	...
	'Vision 1', {
		...
		vision1Desc: { type: Types.Textarea, default: '公司从事多年射频和雷达产品研发、制造与销售。现有技术人员60人，其中研究生以上学历15人，本科学历20人，大专学历25人。', label: '愿景1-描述', note: '不超过70字' },
	},
	'Vision 2', {
		vision2Title: { type: Types.Text, default: '精致', initial: true, label: '愿景2-标题', note: '必填，不超过10字' },
		vision2Desc: { type: Types.Textarea, default: '产品+服务，自主研发，满足大众客户需求，同时发展定制性业务.', label: '愿景2-描述', note: '不超过70字' },
	},
	'Vision 3', {
		vision3Title: { type: Types.Text, default: '创新', initial: true, label: '愿景3-标题', note: '必填，不超过10字' },
		vision3Desc: { type: Types.Textarea, default: '拥有射频方面核心技术知识产权近30项，在射频研发设计和批量生产方面有较深的技术积累和丰富的经验。', label: '愿景3-描述', note: '不超过70字' },
	},
	'Gerneral Field', {
