...
Antenae.add(
	'Top Section', {
		...
		antenaeDesc: { type: Types.Textarea, default: '桑瑞通信始终以技术创新为企业持续发展的核心，先后成功开发了达到国际先进水平的GSM、CDMA、3G、4G、LTE以及WiFi / WiMAX基站电调天线及其集中控制优化系统。通信产品主要包括移动通信基站天线、一体化美化天线、美化外罩产品等。同时，公司可根据客户需求，为其量身定做包括网络架构设计、产品配置选型、检测及优化服务等内容的移动覆盖综合解决方案。', initial: true, label: '页面总描述' },
	},
	'Main Section', {
