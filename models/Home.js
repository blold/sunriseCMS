...
Home.add(
	...
	'Service Section', {
		...
		service1Desc: { type: Types.Textarea, collapse: true, default: '为国内外运营商客户提供移动网络覆盖及行业应用整体解决方案和服务', label: '服务1短描述' },
		service2Title: { type: Types.Text, required: true, default: '地质环境', label: '服务2标题' },
		service2Desc: { type: Types.Textarea, collapse: true, default: '采用高频雷达传感器，实时监测滑坡变化动向，提供直观的有价值的自然灾害预警信息，提高预警的效率和准确性，减少生命和财产损失', label: '服务2短描述' },
		service3Title: { type: Types.Text, required: true, default: '水利电力', label: '服务3标题' },
		service3Desc: { type: Types.Textarea, collapse: true, default: '大坝安全自动化监测系统实现了监测工程动态数据的采集、传输、数据汇集及设备控制自动化，为用户的现场监控、异地监视提供方便、高效、快捷的服务', label: '服务3短描述' },
		service4Title: { type: Types.Text, required: true, default: '智能交通', label: '服务4标题' },
		service4Desc: { type: Types.Textarea, collapse: true, default: '智能驾驶、雷达测速、无人飞机航拍测距、测速', label: '服务4短描述' },
