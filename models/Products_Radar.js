...
var ProuctSeries_Radar = new keystone.List('products_radar', { defaultColumns: 'productTitle, productShortDesc, createdAt', sortable: true });
ProuctSeries_Radar.add(
	'Main Section', {
